  ...
  return (
    <section className="py-16 px-4 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        <h2 className="font-playfair text-3xl md:text-4xl font-bold text-black mb-8 text-center">Videos</h2>
        ...
        <div className="text-center mt-12">
          <p className="font-vietnam text-gray-600 mb-4">For more videos, visit our YouTube channel</p>
          <a
