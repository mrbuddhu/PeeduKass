...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-black md:-mt-20">
      ...
      {/* Hero Content */}
      <div className="relative z-10 flex items-end justify-center h-full pb-20 md:pb-32" style={{ paddingBottom: `calc(5rem + env(safe-area-inset-bottom, 0px))` }}>
      ...
      {/* Scroll indicator */}
      <div className="absolute left-1/2 transform -translate-x-1/2 z-10 bottom-4 md:bottom-12" style={{ bottom: `calc(1rem + env(safe-area-inset-bottom, 0px))` }}>
